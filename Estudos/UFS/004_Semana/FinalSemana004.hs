...
meuBancoDados = [("ivo", "livro A"), ("carlos", "livro B"),("joana", "livro C"),("gui", "livro D"),("pedrino", "livro A")] 
...
livroEstaEmprestado livro = head [livroEmprestado == livro| (_,livroEmprestado) <- meuBancoDados]
